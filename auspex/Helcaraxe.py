...
def cnn_predict(i_res, i_obs, f_res, f_obs):
    """
    ...
    All parameters have to have the same length! The index of the list is relevant.
    ...
    # Takes I_obs value if available and returns list of models prediction
